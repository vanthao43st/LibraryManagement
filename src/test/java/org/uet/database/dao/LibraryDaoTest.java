...
class LibraryDaoTest {
    ...
    void testCheckIfBookAsync() {
        CompletableFuture<Boolean> checkIfBookFuture = libraryDao.checkIfBookAsync("0001");
    ...
    void testCheckAvailabilityAsync() {
        CompletableFuture<Boolean> checkAvailabilityFuture = libraryDao.checkAvailabilityAsync("0001", 1);
    ...
    void testIsUserExistedAsync() {
        CompletableFuture<Boolean> isUserExistedFuture = libraryDao.isUserExistedAsync("17020377");
    ...
    void testIsDocumentCodeExistedAsync() {
        CompletableFuture<Boolean> isDocumentCodeExistedFuture = libraryDao.isDocumentCodeExistedAsync("0001");
    ...
    void testGetLibraryIdAsync() {
        CompletableFuture<Integer> getLibraryIdFuture = libraryDao.getLibraryIdAsync("17020309", "2044", 4);
